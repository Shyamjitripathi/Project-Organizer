  ...
  if (!props.loggedIn) {
    return (
      <main className="form-signin text-center">
        <Link to="/">
          <img src={LogoImage} alt="ProjectBoard Logo" width="200" height="200" />
        </Link>
        <h1 className="h3 mb-3 fw-normal login-heading">Welcome</h1>
        <form onSubmit={handleSubmit}>
          ...
          <Link className="signup-link" to="/register">
            Don't have an account? Sign up for ProjectBoard!
          </Link>
        </form>
      </main>
    );
